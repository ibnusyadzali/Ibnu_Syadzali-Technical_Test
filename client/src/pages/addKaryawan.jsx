...
function AddKaryawan() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await fetch(`http://localhost:3001/karyawan/add`, {
        method: "POST",
        headers: {
          ...
          <Form onSubmit={handleSubmit}>
            <Row className="mb-3">
              ...
              <Col className="col-8">
                ...
                <select name="id_jabatan" className="form-control mb-1 w-50 text-center" onChange={handleInputChange} defaultValue={values.id_jabatan}>
                ...
                <Form.Check className="py-2" inline label="L" name="gender" type="radio" id="inline-radio-L" value="L" onChange={handleInputChange} />
                <Form.Check inline label="P" name="gender" type="radio" id="inline-radio-P" value="P" onChange={handleInputChange} />
